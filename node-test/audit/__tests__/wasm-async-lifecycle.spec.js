...
//
// Every scenario runs in a child process (`../wasm-async-child.cjs`) with a
...
const childPath = path.join(__dirname, "..", "wasm-async-child.cjs");
...
const flavors = [
  { file: "async_audit.wasm32-wasi.wasm", threaded: true },
  { file: "async_audit.wasm32-wasip1.wasm", threaded: false },
]
