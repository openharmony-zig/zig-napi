...
pub const napi_env__ = types.napi_env__;
pub const napi_value__ = types.napi_value__;
pub const napi_ref__ = types.napi_ref__;
pub const napi_handle_scope__ = types.napi_handle_scope__;
pub const napi_escapable_handle_scope__ = types.napi_escapable_handle_scope__;
pub const napi_callback_info__ = types.napi_callback_info__;
pub const napi_deferred__ = types.napi_deferred__;
pub const napi_callback_scope__ = types.napi_callback_scope__;
pub const napi_async_context__ = types.napi_async_context__;
pub const napi_async_work__ = types.napi_async_work__;

pub const napi_env = types.napi_env;
pub const node_api_basic_env = types.node_api_basic_env;
pub const napi_value = types.napi_value;
pub const napi_ref = types.napi_ref;
pub const napi_handle_scope = types.napi_handle_scope;
pub const napi_escapable_handle_scope = types.napi_escapable_handle_scope;
pub const napi_callback_info = types.napi_callback_info;
pub const napi_deferred = types.napi_deferred;
pub const napi_callback_scope = types.napi_callback_scope;
pub const napi_async_context = types.napi_async_context;
pub const napi_async_work = types.napi_async_work;

pub const napi_property_attributes = types.napi_property_attributes;
pub const napi_default = types.napi_default;
pub const napi_writable = types.napi_writable;
pub const napi_enumerable = types.napi_enumerable;
pub const napi_configurable = types.napi_configurable;
pub const napi_static = types.napi_static;
pub const napi_default_method = types.napi_default_method;
pub const napi_default_jsproperty = types.napi_default_jsproperty;

pub const napi_valuetype = types.napi_valuetype;
pub const napi_undefined = types.napi_undefined;
pub const napi_null = types.napi_null;
pub const napi_boolean = types.napi_boolean;
pub const napi_number = types.napi_number;
pub const napi_string = types.napi_string;
pub const napi_symbol = types.napi_symbol;
pub const napi_object = types.napi_object;
pub const napi_function = types.napi_function;
pub const napi_external = types.napi_external;

pub const napi_typedarray_type = types.napi_typedarray_type;
pub const napi_int8_array = types.napi_int8_array;
pub const napi_uint8_array = types.napi_uint8_array;
pub const napi_uint8_clamped_array = types.napi_uint8_clamped_array;
pub const napi_int16_array = types.napi_int16_array;
pub const napi_uint16_array = types.napi_uint16_array;
pub const napi_int32_array = types.napi_int32_array;
pub const napi_uint32_array = types.napi_uint32_array;
pub const napi_float32_array = types.napi_float32_array;
pub const napi_float64_array = types.napi_float64_array;

pub const napi_status = types.napi_status;
pub const napi_ok = types.napi_ok;
pub const napi_invalid_arg = types.napi_invalid_arg;
pub const napi_object_expected = types.napi_object_expected;
pub const napi_string_expected = types.napi_string_expected;
pub const napi_name_expected = types.napi_name_expected;
pub const napi_function_expected = types.napi_function_expected;
pub const napi_number_expected = types.napi_number_expected;
pub const napi_boolean_expected = types.napi_boolean_expected;
pub const napi_array_expected = types.napi_array_expected;
pub const napi_generic_failure = types.napi_generic_failure;
pub const napi_pending_exception = types.napi_pending_exception;
pub const napi_cancelled = types.napi_cancelled;
pub const napi_escape_called_twice = types.napi_escape_called_twice;
pub const napi_handle_scope_mismatch = types.napi_handle_scope_mismatch;
pub const napi_callback_scope_mismatch = types.napi_callback_scope_mismatch;
pub const napi_queue_full = types.napi_queue_full;
pub const napi_closing = types.napi_closing;
pub const napi_bigint_expected = types.napi_bigint_expected;
pub const napi_date_expected = types.napi_date_expected;
pub const napi_arraybuffer_expected = types.napi_arraybuffer_expected;
pub const napi_detachable_arraybuffer_expected = types.napi_detachable_arraybuffer_expected;
pub const napi_would_deadlock = types.napi_would_deadlock;
pub const napi_no_external_buffers_allowed = types.napi_no_external_buffers_allowed;
pub const napi_cannot_run_js = types.napi_cannot_run_js;

pub const napi_callback = types.napi_callback;
pub const napi_finalize = types.napi_finalize;
pub const node_api_basic_finalize = types.node_api_basic_finalize;
pub const napi_cleanup_hook = types.napi_cleanup_hook;
pub const napi_async_execute_callback = types.napi_async_execute_callback;
pub const napi_async_complete_callback = types.napi_async_complete_callback;
pub const napi_addon_register_func = types.napi_addon_register_func;
pub const napi_property_descriptor = types.napi_property_descriptor;
pub const napi_extended_error_info = types.napi_extended_error_info;
pub const napi_node_version = types.napi_node_version;
pub const napi_module = types.napi_module;
