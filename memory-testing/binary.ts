...
export function exerciseBinaryWrappers(native: NativeAddon) {
  for (let i = 0; i < 250; i++) {
    ...
    assertEqual(native.arraybuffer_first_byte(newArrayBufferValue), 0x6b, "arraybuffer new first byte");
    ...
    assertEqual(native.int16_typedarray_sum(native.create_int16_typedarray_copy()), 4, "int16 typedarray created sum");
    assertEqual(native.int16_typedarray_sum(new Int16Array([-1, 2, 3])), 4, "int16 typedarray input sum");
    assertEqual(native.uint16_typedarray_sum(native.create_uint16_typedarray_copy()), 15, "uint16 typedarray created sum");
    assertEqual(native.uint16_typedarray_sum(new Uint16Array([4, 5, 6])), 15, "uint16 typedarray input sum");
    assertEqual(native.int32_typedarray_sum(native.create_int32_typedarray_copy()), 10, "int32 typedarray created sum");
    assertEqual(native.int32_typedarray_sum(new Int32Array([-7, 8, 9])), 10, "int32 typedarray input sum");
    assertEqual(native.uint32_typedarray_sum(native.create_uint32_typedarray_copy()), 33, "uint32 typedarray created sum");
    assertEqual(native.uint32_typedarray_sum(new Uint32Array([10, 11, 12])), 33, "uint32 typedarray input sum");
    assertEqual(native.float32_typedarray_sum(new Float32Array([1.5, 2.5, -1])), 3, "float32 typedarray input sum");
    assertEqual(native.float64_typedarray_sum(native.create_float64_typedarray_copy()), 3, "float64 typedarray created sum");
    assertEqual(native.float64_typedarray_sum(new Float64Array([1.5, 2.25, -0.75])), 3, "float64 typedarray input sum");
    ...
    assertEqual(native.dataview_uint32_le(new DataView(new Uint8Array([0x78, 0x56, 0x34, 0x12]).buffer)), 0x12345678, "dataview input uint32");
